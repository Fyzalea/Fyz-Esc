...
```
![mst3-davtest](../img/Metasploitable3/mst3-davtest.png)
...
```
![mst3-msfvenom](../img/Metasploitable3/mst3-msfvenom.png)
![mst3-upload_post](../img/Metasploitable3/mst3-upload_post.png)
渗透开始：
```Metasploit
...
![mst3-meterpreter](../img/Metasploitable3/mst3-meterpreter.png)
...
```
![mst3-login](../img/Metasploitable3/mst3-login.png)
输入凭证`vagrant:vagrant`
![mst3-login_2](../img/Metasploitable3/mst3-login_2.png)
然后：
![mst3-desktop_warning](../img/Metasploitable3/mst3-desktop_warning.png)
关掉这个窗口，我们就得到了 **Windows Server 2008 R2** 的桌面：
![mst3-desktop_success](../img/Metasploitable3/mst3-desktop_success.png)
成功拿下。[^2]
